...
%%EOF`;
        ...
        const MOCK_COMMUNES_GLOBAL = {
            "المنيعة": ["المنيعة المركز", "حاسي القارة", "حاسي غانم", "بلدية أخرى (اكتبها في العنوان)"],
            "غرداية": ["غرداية المركز", "العطف", "بني يزقن", "القرارة", "بريان", "بلدية أخرى (اكتبها في العنوان)"],
            "ورقلة": ["ورقلة", "حاسي مسعود", "تقرت", "الرويسات", "بلدية أخرى (اكتبها في العنوان)"],
            "الجزائر": ["الجزائر الوسطى", "باب الواد", "سيدي امحمد", "الشراقة", "المرسى", "بلدية أخرى (اكتبها في العنوان)"],
            "وهران": ["وهران المركز", "بئر الجير", "السانية", "قديل", "بلدية أخرى (اكتبها في العنوان)"],
            "قسنطينة": ["قسنطينة المركز", "الخروب", "حامة بوزيان", "بلدية أخرى (اكتبها في العنوان)"],
            "سطيف": ["سطيف المركز", "العلمة", "عين أرنات", "بلدية أخرى (اكتبها في العنوان)"],
        };
        ...
        function populateStaffCommunes() {
            ...
            if (wilaya) {
                const list = MOCK_COMMUNES_GLOBAL[wilaya] || [wilaya + " (المركز)", "بلدية أخرى (اكتبها في العنوان)"];
                list.forEach(c => {
