...
# Replace the wilayasArray definition
# It looks like: const wilayasArray = [ {n:"أدرار"}, ... ];
pattern = r'const wilayasArray = \[\s*\{n:"أدرار"}.*?\];'
replacement = f'const wilayasArray = {arr_content};'

new_content = re.sub(pattern, replacement, content, flags=re.DOTALL)
if new_content != content:
    with open('web/customer-home.html', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("Updated wilayasArray in customer-home.html")
else:
    print("Could not find wilayasArray in customer-home.html")
